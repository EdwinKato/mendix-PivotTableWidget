...
public class UserActionsRegistrar implements EventHandler
{
	...
	public void handleEvent(Event event)
	{
		if (event.getTopic().equals(com.mendix.core.event.EventConstants.ModelLoadedTopic()))        
		{
			...
			component.actionRegistry().registerUserAction(myfirstmodule.actions.GenerateRandomInteger.class);
			component.actionRegistry().registerUserAction(myfirstmodule.actions.GetIncidentList.class);
			component.actionRegistry().registerUserAction(myfirstmodule.actions.SalesOrder_GenerateAction.class);
			component.actionRegistry().registerUserAction(myfirstmodule.actions.TransientRotatedColumnHeaderData_CreateCssAction.class);
			component.actionRegistry().registerUserAction(myfirstmodule.actions.TransientRotatedColumnHeaderData_SetInitialValuesAction.class);
